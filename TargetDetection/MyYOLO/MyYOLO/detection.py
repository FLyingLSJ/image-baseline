...
# Train
parser.add_argument('-vr', '--val_rate', default=1, type=int, metavar='N',
                    help='val rate')
...
parser.add_argument('-ctde', '--change_train_data_epoch', default=80, type=int, metavar='N',
                    help='change_train_data_epoch')
parser.add_argument('-bs', '--batch_size', default=4, type=int, metavar='N',
                    help='batch_size')
# Test
