...
parser.add_argument('-ctde', '--change_train_data_epoch', default=150, type=int, metavar='N',
                    help='change_train_data_epoch')
parser.add_argument('-bs', '--batch_size', default=10, type=int, metavar='N',
                    help='batch_size')
# Test
parser.add_argument('-rp', '--result_path', default='./data/predict_ljf/', type=str, metavar='N',
                    help='result_path')
parser.add_argument('-di', '--draw_image', default=True, type=bool, metavar='N',
                    help='draw image when testing')
parser.add_argument('-selt', '--select_threshold', default='False', type=str, metavar='N',
